...
public class HorizontalLinearRecyclerViewSampleActivity extends AppCompatActivity implements ExpandableRecyclerAdapter.ExpandCollapseListener {
    ...
    private OnClickListener mExpandParentTwoClickListener = new OnClickListener() {
        @Override
    ...
    private OnClickListener mCollapseParentTwoClickListener = new OnClickListener() {
        @Override
        public void onClick(View v) {
    ...
    private OnClickListener mExpandAllClickListener = new OnClickListener() {
        @Override
        public void onClick(View v) {
    ...
    private OnClickListener mCollapseAllClickListener = new OnClickListener() {
        @Override
        public void onClick(View v) {
